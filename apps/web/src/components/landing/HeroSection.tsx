    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className={`${CONTAINER} relative z-10 text-center`}>
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/80 px-4 py-1.5 text-xs font-mono text-muted-foreground"
        >
        ...
        >
          ...
          >
            <Link
              ...
              className="group relative inline-flex items-center gap-2 bg-primary text-white rounded-lg px-6 py-3 text-sm font-medium transition-all duration-200 hover:bg-primary-hover hover:shadow-card-hover overflow-hidden"
            >
          ...
          >
            <Link
              href="/docs"
              className="inline-flex items-center gap-2 border border-border rounded-lg px-6 py-3 text-sm font-medium text-foreground hover:bg-surface-alt/50 hover:border-[var(--border-hover)] transition-all duration-200"
            >
